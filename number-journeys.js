  ...
  "156": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "責任關愛",
        energy: "最終展現照顧與服務能力",
        influence: "你的工作天賦在於在自由探索中照顧他人"
      }
    },
    summary: "你從獨立開創開始，透過自由探索，最終成為照顧者。",
    advice: "先勇敢開創自己的道路，再自由探索各種可能，最後在這個過程中學習照顧與服務。"
  },
  ...
  "516": {
    ...
    journey: {
      ...
      process: {
        ...
        name: "獨立開創",
        energy: "透過自主決策與行動來推進",
        influence: "在工作中你需要將自由的探索轉化為實際行動"
      },
      result: {
        number: 6,
        name: "責任關愛",
    ...
    summary: "你從自由探索開始，透過獨立開創，最終成為照顧者。",
    advice: "先允許自己自由探索，再勇敢開創具體方向，最後在這個過程中學習照顧與服務。"
  },
  ...
  "246": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "責任關愛",
        energy: "最終展現照顧與服務能力",
        influence: "你的工作天賦在於在和諧穩定中照顧他人"
      }
    },
    summary: "你從合作協調開始，透過穩定建設，最終成為照顧者。",
    advice: "先建立良好的人際關係，再建構穩固的系統，最後在這個和諧穩定中照顧他人。"
  },
  ...
  "426": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "責任關愛",
        energy: "最終展現照顧與服務能力",
        influence: "你的工作天賦在於在穩定基礎上照顧人際關係"
      }
    },
    summary: "你從穩定建設開始，透過合作協調，最終成為照顧者。",
    advice: "先建立穩固的基礎，再與人合作協調，最後在這個基礎上照顧他人的需求。"
  },
  ...
  "336": {
    ...
    journey: {
      ...
      process: {
        ...
        influence: "工作中你特別擅長用創意方式表達與溝通"
      },
      result: {
        number: 6,
        name: "責任關愛",
        energy: "最終展現照顧與服務能力",
        influence: "你的工作天賦在於用創意表達來照顧他人"
      }
    },
    summary: "你從創意表達開始，持續透過表達，最終成為照顧者。",
    advice: "你的強項在於創意表達，先用它來分享快樂，再深化為照顧他人的方式。"
  },
  ...
  "167": {
    ...
    journey: {
      ...
      process: {
        ...
        name: "責任關愛",
        energy: "透過照顧與服務來推進",
        influence: "在工作中你關注他人的需求，善於創造和諧"
      },
      result: {
        number: 7,
        name: "靜心思考",
        energy: "最終展現深度思考與分析能力",
        influence: "你的工作天賦在於在關愛中發展深刻的洞察力"
      }
    },
    summary: "你從獨立開創開始，透過責任關愛，最終成為思考者。",
    advice: "先勇敢開創自己的道路，再學習照顧他人，最後在這個過程中發展深度思考能力。"
  },
  ...
  "617": {
    ...
    journey: {
      start: {
        number: 6,
        name: "責任關愛",
        energy: "從照顧服務出發，帶著和諧的能量",
        influence: "你的事業動機始於想要創造美好的環境、照顧他人"
      },
      process: {
        number: 1,
        name: "獨立開創",
        energy: "透過自主決策與行動來推進",
        influence: "在工作中你需要將關愛轉化為實際行動"
      },
      result: {
        number: 7,
        name: "靜心思考",
    ...
    summary: "你從責任關愛開始，透過獨立開創，最終成為思考者。",
    advice: "先展現你的關愛，再勇敢開創具體方向，最後在這個過程中發展深度思考能力。"
  },
  ...
  "268": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "豐盛實現",
        energy: "最終展現成就與影響力",
        influence: "你的工作天賦在於將人際關愛轉化為實際成就"
      }
    },
    summary: "你從合作協調開始，透過責任關愛，最終成為實現者。",
    advice: "先建立良好的人際關係，再展現你的關愛，最後將這些和諧關係轉化為實際成就。"
  },
  ...
  "628": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "豐盛實現",
        energy: "最終展現成就與影響力",
        influence: "你的工作天賦在於將關愛轉化為有影響力的成果"
      }
    },
    summary: "你從責任關愛開始，透過合作協調，最終成為實現者。",
    advice: "先展現你的關愛，再與人合作協調，最後將這些和諧關係轉化為實際成就。"
  },
  ...
  "369": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "圓滿整合",
        energy: "最終展現包容與完成能力",
        influence: "你的工作天賦在於用創意關愛完成更大的善"
      }
    },
    summary: "你從創意表達開始，透過責任關愛，最終成為整合者。",
    advice: "先自由表達你的創意，再展現你的關愛，最後將這兩者整合為對他人有益的貢獻。"
  },
  ...
  "639": {
    ...
    journey: {
      ...
      result: {
        ...
        name: "圓滿整合",
        energy: "最終展現包容與完成能力",
        influence: "你的工作天賦在於用關愛創意完成更大的善"
      }
    },
    summary: "你從責任關愛開始，透過創意表達，最終成為整合者。",
    advice: "先展現你的關愛，再用創意方式表達，最後將這兩者整合為對他人有益的貢獻。"
  },
